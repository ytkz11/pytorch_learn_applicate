...
from func.read_tif_to_np import read_tif_to_np
'''loading data'''
original_msi = np.load('./images/GF2_BJ_mss.npy')
original_pan = np.load('./images/GF2_BJ_pan.npy')

# mss = './images/pms_Clip1.tif'
# pan = './images/pan_Clip1.tif'
mss = './images/pms_msi.tif'
pan = './images/pan_msi.tif'
